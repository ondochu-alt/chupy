...
export const metadata: Metadata = {
  title: "올리브영 바디케어 인플루언서 마케팅 | 추예은",
  description:
    "퍼널 단계별 KPI를 설정한 인플루언서 전략으로 올리브영 바디케어 카테고리 랭킹 1위를 달성한 캠페인.",
};
        ...
        <section className="max-w-7xl mx-auto px-5 sm:px-6 py-14 md:py-20">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start lg:items-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                퍼널 단계별 KPI를 설정한 인플루언서 전략으로
                <br className="hidden sm:block" />
                올리브영 바디케어 카테고리 랭킹 1위를 달성한 캠페인
              </p>
        ...
        <section className="max-w-7xl mx-auto px-5 sm:px-6 py-14 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            <AnimatedSection delay={0}>
              ...
              >
                {[
                  "인플루언서 협업 콘텐츠 기획 및 제작 부서 핸들링",
                  "매출 부스팅을 위한 SNS 채널별 인플루언서 관리 (인스타그램 / 틱톡 / 네이버 블로그 / 유튜브)",
                  "타 브랜드 콜라보레이션 협업 기획 (이팅더즈매터 바터 콜라보)",
                ].map((item) => (
            ...
            <AnimatedSection delay={100}>
              ...
              >
                ...
                올리브영 입점 후 초기 랭킹이 정체되는 문제가 발생했습니다. 감 기반의 인플루언서
                선정에서 벗어나, 시즌 키워드와 퍼포먼스 데이터로 검증된 전략을 수립해 6개월 만에
                바디케어 카테고리 1위를 달성했습니다.
              </p>
              <div
              ...
              >
                ...
                <p className="text-sm text-[#514347] leading-relaxed italic">
                  "퍼널 단계별로 명확한 KPI를 설정하고, 브랜드 자산 확보와 매출 부스팅을 위한
                  셀럽 발굴 및 PPL 광고로 올리브영 랭킹 1위 달성"
                </p>
              </div>
            </AnimatedSection>
          </div>
              ...
              {[
                {
                  ...
                  desc: "시즌에 맞는 키워드와 스토리로 구독자들의 흥미를 유도하고 구매를 촉진했습니다. 소유 '연말 선물 추천템', 여름 맞이 제품 추천 등 시즌성을 적극 활용한 인플루언서 콘텐츠를 기획했습니다.",
                },
                {
                  num: "02",
                  title: "서포터즈 연계 셀럽 PPL 광고",
                  desc: "브랜드 서포터즈와 유사한 성격의 인플루언서 광고를 진행해 브랜드 인지도와 이미지를 동시에 제고했습니다. 리쥬라이크 협업으로 유튜브 인기 급상승 동영상 5위를 달성했습니다.",
                },
                {
                  num: "03",
                  title: "인플루언서 콘텐츠 2차 활용",
                  desc: "1차 인플루언서 콘텐츠를 퍼포먼스 광고 소재와 커머스 채널에 2차 활용했습니다. 타 플랫폼(네이버)에서 '임산부 유튜버 OOO가 사용한~' 등 연관 키워드를 자연스럽게 확보했습니다.",
                },
              ].map((card, i) => (
              ...
              {[
                {
                  step: "STEP 01",
                  date: "2022.10",
                  title: "인플루언서 리소스 파악 & 채널 전략 수립",
                  desc: "SNS 채널별(인스타그램/틱톡/네이버 블로그/유튜브) 인플루언서 유형 및 효과 분석. 비건 바디케어 브랜드 디어도어의 포지션에 맞는 인플루언서 Pool 구성 및 채널 전략 수립.",
                },
                {
                  step: "STEP 02",
                  date: "2022.11 – 2023.04",
                  title: "시즌별 인플루언서 캠페인 실행",
                  desc: "시즌 키워드와 스토리를 중심으로 캠페인 기획. 소유 '연말 선물 추천', 여름 바디케어 루틴 등 시즌성 콘텐츠 집행. 이팅더즈매터와 바터 콜라보레이션 협업 기획.",
                },
                {
                  step: "STEP 03",
                  date: "2023.04 – 2023.06",
                  title: "서포터즈 연계 셀럽 PPL",
                  desc: "브랜드 서포터즈 타겟과 연관된 인플루언서 '리쥬라이크' PPL 진행. 유튜브 인기 급상승 동영상 5위 달성. 네이버에서 연관 키워드 자연 확보.",
                },
                {
                  step: "STEP 04",
                  date: "2023.07",
                  title: "올리브영 1위 & 연 최고 매출 달성",
                  desc: "인플루언서 콘텐츠 2차 활용 퍼포먼스 소재 집행으로 전환 극대화. 올리브영 바디케어 카테고리 1위(전체 7위) 달성. 2023.07.03~04 연 최고 매출 기록.",
                },
              ].map((s, i) => (
          ...
          <div className="flex flex-col gap-8 md:gap-10">
            {[
              ...
              },
              {
                ...
                desc: "셀럽 PPL로 브랜드 이미지를 구축하고, 퍼포먼스 소재로 즉각적 전환을 이끄는 투트랙 전략이 올리브영 1위와 연 최고 매출이라는 두 성과를 만들었습니다.",
              },
            ].map((l, i) => (
        ...
        <section className="w-full bg-[#f4f4f5] border-t border-[#e7e8e9] py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-5 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { tag: "BEAUTY EXPO", name: "일레븐휴즈데이 박람회 기획", href: "/#work", img: "/page005_img03.jpeg" },
                { tag: "GLOBAL", name: "해외 리뷰어 시딩 캠페인", href: "/#work", img: "/seeding_combined.jpeg" },
                { tag: "LIVE", name: "네이버 쇼핑 라이브 기획", href: "/#work", img: "/naver_live_combined.jpeg" },
              ].map((p, i) => (
